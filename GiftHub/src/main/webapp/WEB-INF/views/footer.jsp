     ...
     <!-- Footer Start -->
        <div class="container-fluid bg-primary text-light footer wow fadeIn" data-wow-delay="0.1s">
            <div class="container py-1 px-lg-5">
                <div class="row g-5" style="font-size: 15px;">
                	
                    <div class="col-md-6 col-lg-3">
                        <p class="section-title text-white h5 mb-4">Address<span></span></p>
                        <p><i class="fa fa-map-marker-alt me-3"></i>서울특별시 강남구 선릉로 428</p>
                    ...
                    <div class="col-md-6 col-lg-3">
                    	<p class="section-title text-white h5 mb-4">About Us<span></span></p>
                         <p>대표ㅣ김은진</p>
                         <p>부대표ㅣ이성준</p>
                		 <p>파트너ㅣ이수민 허동민 노유진 황규빈</p>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <p class="section-title text-white h5 mb-4">GiftHub 이용약관<span></span></p>
                        <p>> 개인정보처리방침</p>
                        <p>> 서비스이용약관</p>
                        <p>> 전자금융거래이용약관</p>
                        <p>> 윤리강령</p>
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <!-- <div class="position-relative w-100 mt-3">
                            ...
                            <button type="button" class="btn shadow-none position-absolute top-0 end-0 mt-1 me-2">
                            	<i class="fa fa-paper-plane text-primary fs-4" style="color: #0058C6 !important;"></i>
                            </button>
                        </div> -->
                    </div>
                </div>
					...
					<div class="copyright">
						<div class="row">
							<div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
								&copy; <a class="border-bottom">GiftHub</a>, All Right Reserved.
							</div>
