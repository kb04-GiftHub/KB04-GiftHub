                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <form>
                                ...
                                <div class="row g-3">
									...
									<table>
										<tr>
											<th>게시물 번호</th><td>${dto.promotionNo}</td>
										</tr>
										<tr>
											<th>게시물 종류</th><td>${dto.promotionType}</td>
										</tr>
										<tr>
											<th>게시물 제목</th><td>${dto.promotionTitle}</td>
										</tr>
										<tr>
											<th>게시물 작성일</th><td>${dto.promotionDate}</td>
										</tr>
										<tr>
											<th>게시물 내용Content</th>
										</tr>
										<tr>
											<td colspan="2"><textarea rows="3" cols="60">${dto.promotioncontent}</textarea></td>
										</tr>
										</table>                                  
                                    <div class="col-12">
