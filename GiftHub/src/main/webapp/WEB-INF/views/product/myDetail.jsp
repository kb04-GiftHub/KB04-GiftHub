				...
				<div class="col-lg-7">
					...
					<p class="text-center mb-4"></p>
						<div class="row g-3">
							...
							<div class="col-6">
								<button class="btn btn-primary w-100 py-3" id="backBtn" style="margin-top: 50px;" onclick="window.location.href = '/product/product_delete'">삭제하기</button>
							</div>
							<div class="col-6">
								<button class="btn btn-primary w-100 py-3" id="backBtn" style="margin-top: 50px;" onclick="window.location.href = '/product'">수정하기</button>
							</div>
						</div>
					</div>
				</div>
