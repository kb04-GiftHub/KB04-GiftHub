				...
				<div class="col-lg-7">
					<div class="wow fadeInUp" data-wow-delay="0.3s">
						<p class="text-center mb-4">
							당신의 작은 정성이 꿈과 희망이 됩니다. <br> 후원금은 홈페이지를 통하여 공개됩니다.</a>
						</p>
						<form>
							<div class="row g-3">
								<div class="col-md-6">
            ...
            console.error('포인트 정보를 가져오는 중 오류 발생:', error);
									...
									<div class="form-floating">
										<input type="number" class="form-control" id="pointToUse"
											placeholder="사용할 포인트"> <label for="pointToUse">사용할
											포인트</label>
									</div>
									<script>
// 현재 보유 포인트
									...
									<div class="form-group">
										<div class="form-check">
											<input type="checkbox" class="form-check-input"
												id="privacyCheck"> <label class="form-check-label"
												for="privacyCheck">기부 증서 발급</label><br>
										</div>
									</div>
									<div class="col-12">
										<button class="btn btn-primary w-100 py-3" type="button"
											id="donationButton">기부하기</button>
