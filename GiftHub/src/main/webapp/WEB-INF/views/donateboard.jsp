...
<div class="container-xxl py-5">
    <div class="container py-5 px-lg-5">
        <div class="wow fadeInUp" data-wow-delay="0.1s">
            <p class="section-title text-secondary justify-content-center"><span></span>Donate Promotion<span></span></p>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item d-flex flex-column text-center rounded">
                    <div class="service-image flex-shrink-0 flex-shrink-0 rounded-circle mx-auto" style="width: 250px; height: 250px; overflow: hidden;">
                        <img src="img/사랑의 열매.png" alt="" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    <h5 class="mb-3">사랑의 열매</h5>
                    <p class="m-0">사랑의 열매는 나와 가족을 사랑하는 마음으로 이웃에게 사랑을 전하자는 나눔의 의미를 담고 있습니다.</p>
         ...
         <!-- Service 2 -->
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item d-flex flex-column text-center rounded">
                    <div class="service-image flex-shrink-0 flex-shrink-0 rounded-circle mx-auto" style="width: 250px; height: 250px; overflow: hidden;">
                        <img src="img/유니세프.png" alt="" style="width: 80%; height: 80%; object-fit: cover;">
                    </div>
                    <h5 class="mb-3">유니세프</h5>
                    <p class="m-0">월 30,000원 이면, 전 세계 어린이를 위해 연필 7,200 자루를 지원할 수 있습니다.</p>
                    <a class="btn btn-square" href="http://localhost:8080/donate"></a>
                </div>
            </div>
                  <!-- Service 3 -->
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex flex-column text-center rounded">
                    <div class="service-image flex-shrink-0 flex-shrink-0 rounded-circle mx-auto" style="width: 250px; height: 250px; overflow: hidden;">
                        <img src="img/적십자.png" alt="" style="width: 70%; height: 70%; object-fit: cover;">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item d-flex flex-column text-center rounded">
                    <div class="service-image flex-shrink-0 flex-shrink-0 rounded-circle mx-auto" style="width: 250px; height: 250px; overflow: hidden;">
                        <img src="img/월드비전.png" alt="" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    <h5 class="mb-3">월드비전</h5>
                    <p class="m-0">오늘도 아픈 가족을 돌보기 위해 택배를 나르는 16살 용일이에게 따뜻한 관심을 가져주세요.</p>
                    <a class="btn btn-square" href="http://localhost:8080/donate"></a>
                </div>
            </div>
        ...
        <!-- Service 5 (한국 컴패션) -->
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item d-flex flex-column text-center rounded">
                    <div class="service-image flex-shrink-0 flex-shrink-0 rounded-circle mx-auto" style="width: 250px; height: 250px; overflow: hidden;">
                        <img src="img/한국컴패션.png" alt="" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex flex-column text-center rounded">
                    <div class="service-image flex-shrink-0 flex-shrink-0 rounded-circle mx-auto" style="width: 250px; height: 250px; overflow: hidden;">
                        <img src="img/세이브더칠드런.png" alt="" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    <h5 class="mb-3">세이브더칠드런</h5>
                    <p class="m-0">오직 아동만을 위해 100년간 활동 중인 투명한 국제NGO. SAVEONE 긴급구호 팔찌. 저소득가정 반찬 지원. 아동 정기후원.</p>
                    <a class="btn btn-square" href="http://localhost:8080/donate"></a>
                </div>
            </div>
        </div>
