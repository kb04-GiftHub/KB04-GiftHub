...
<%-- <%
    String encodedJsonStr = (String) request.getAttribute("encodedJsonStr");
    String decodedJsonStr = new String(Base64.getDecoder().decode(encodedJsonStr));
%> --%>
<html lang="en">
...
<body>
    ...
    <!-- 지도 -->
    <script>
    var encodedJsonStr = "${stores}";
    var decodedJsonStr = atob(encodedJsonStr); // Base64 디코딩
    var objectData = JSON.parse(decodedJsonStr); // JSON 파싱
