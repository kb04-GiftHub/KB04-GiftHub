...
<!-- Include Postcodify JavaScript Libraries -->
...
<div class="container-xxl bg-white p-0">
            ...
            <div class="wow fadeInUp" data-wow-delay="0.1s">
                <form>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            <div class="form-group">
                                <label for="postcodify">주소</label>
                                <style>
                                    /* 검색 키워드 힌트 숨기기 */
                                    .postcodify-dropdown > p {
    ...
    <script>
        // Postcodify 초기화 및 주소 선택 시 주소 입력 필드에 값을 설정합니다.
        $("#postcodify").postcodify({
            onSelect: function (result) {
                // 주소 선택 시 입력 필드에 주소를 채웁니다.
