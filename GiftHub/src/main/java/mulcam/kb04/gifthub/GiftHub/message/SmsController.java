...
public class SmsController {
	...
	public String sendMms(@RequestParam String tel, @RequestParam String content, 
			Model model) throws IOException, RestClientException, InvalidKeyException, NoSuchAlgorithmException, URISyntaxException {
		...
		MessageDto messageDto = new MessageDto("01034803259","안녕");
