...
<body>
		...
		아이디:	 <input type="id" name="abc" value="abc123" readonly><br>
		...
		휴대폰 번호 : <input type="number" name="addr" value="000-0000-0000"><br>
		...
		계약서 <br>
		<input type="checkbox" name="동의" value="ID"> 동의합니다 
		<input type="checkbox" name="동의" value="ID"> 동의하지 않습니다 <br>
